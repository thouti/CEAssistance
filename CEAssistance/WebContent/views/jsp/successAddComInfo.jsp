		...
		<div class="wrapper">
			<div class="header">
				...
				<div class="head_right">
					<div align="left" width="100px;" style="padding:18px 0px 0px 0px;">Mr. <%=session.getAttribute("uName").toString()%></div>
				...
				<div class="right">
					<div style="background-color:#F8F8F8;">
						...
						<table width="40%" class="tabcss_main" align="center">
							<tr><td align="left">YOU WANT TO ADD ANOTHER COMPANY INFO CLICK HERE <a href="addAnotherComponyInfoDtls.html?userId=${userId}">Add More</a></td></tr>
						</table>
					</div>
				</div>
