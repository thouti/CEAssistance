		...
		<div class="wrapper">
			<div class="header">
				...
				<div class="head_right">
					<div align="left" width="100px;" style="padding:18px 0px 0px 0px;">Mr. <b><%=session.getAttribute("uName").toString()%></b></div>
					<div align="left" width="100px;" style="padding:8px 0px 0px 0px;">Account Type: ${commonVo.paymentStatus}</div>
				</div>
				...
				<div id='cssmenu'>
				   <ul>
					  ...
					  <li class='active has-sub'><a href="#" ><span>Products</span></a>
						<ul>
							<li class='last'><a href="userRegisterAgmdate.html?hdName=${userName}&userId=<%=session.getAttribute("userId").toString()%>">AGM</a></li>
						</ul>
					  </li>
				...
				<div class="right">
					<div style="background-color:#F8F8F8;">
						...
						<table width="40%" class="tabcss_main" align="center">
							<tr><td align="left">User Name</td><td align="left">${commonVo.fristName}&nbsp;${commonVo.lastName}</td></tr>
							<tr><td align="left">Date Of Birth</td><td align="left">${commonVo.dob}</td></tr>
							<tr><td align="left">Registered on</td><td align="left">${commonVo.regDate}</td></tr>
							<tr><td align="left">Registered mail id</td><td align="left">${commonVo.email}</td></tr>
							<tr><td align="left">Registered Mobile No</td><td align="left">${commonVo.mobile}</td></tr>
						<tr><td align="left">User ID</td><td align="left">${commonVo.userId}</td></tr>
						</table><%-- </c:forEach> --%>
					</div>
				</div>
